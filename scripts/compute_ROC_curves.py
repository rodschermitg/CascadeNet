...
for model_key in model_dict.keys():
    ...
    for batch in dataloader:
        ...
        labels_flattened_list.append(label.numpy().flatten())
    ...
    labels_flattened = np.concatenate(labels_flattened_list)
    preds_flattened = np.concatenate(preds_flattened_list)

    fpr, tpr, _ = sklearn.metrics.roc_curve(labels_flattened, preds_flattened)
