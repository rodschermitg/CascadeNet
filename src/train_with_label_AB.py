        ...
        if epoch == 0 or (epoch + 1) % config.VAL_INTERVAL == 0:
            ...
            with torch.no_grad():
                for val_batch in val_dataloader:
                    ...
                    val_label_AB = val_batch["label_AB"].to(device)
